...
jQuery.extend( {
	...
	// See prueba/unit/core.js for details concerning isFunction.
...
setDocument = Sizzle.setDocument = function( node ) {
	...
	// so use a roundabout getElementsByName prueba
	...
	if ( (support.qsa = rnative.test( document.querySelectorAll )) ) {
		...
		assert(function( div ) {
			...
			// This is to prueba IE's treatment of not explicitly
			...
			// The prueba attribute must be unknown in Opera but "safe" for WinRT
	...
	trigger: function( event, data, elem, onlyHandlers ) {
		...
		if ( !onlyHandlers && !event.isDefaultPrevented() ) {
			...
			if (
				...
				// Can't use an .isFunction() check here because IE6/7 fails that prueba.
...
function addGetHookIf( conditionFn, hookFn ) {
	...
	return {
		get: function() {
			...
			// Hook needed; redefine it so that the support prueba is not executed again.
